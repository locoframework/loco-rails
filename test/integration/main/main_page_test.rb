    ...
    private
      ...
      def create_articles
        users(:user_zbig).articles.create!(
          ...
          text: 'Why do we need associations between models? Because they make common ' \
        ...
        users(:user_jane).articles.create!(
          title: 'Form Helpers',
          text: 'Forms in web applications are an essential interface for user input. ' \
        ...
        users(:user_jane).articles.create!(
          ...
          text: 'Active Support is the Ruby on Rails component responsible for providing Ruby ' \
            'language extensions, utilities, and other transversal stuff.',
          published_at: 4.days.ago
        )
        users(:user_zbig).articles.create!(
          title: 'Configuring Rails Components',
          text: 'In general, the work of configuring Rails means configuring the ' \
