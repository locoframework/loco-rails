...
Base = (function() {
  ...
  Base.instance = function(obj, attr, opts) {
    ...
    if (this.sharedInstances[validatorName] == null) {
      this.sharedInstances[validatorName] = new __WEBPACK_IMPORTED_MODULE_0__validators___default.a[validatorName];
    }
...
var I18n = function I18n() {
  if (typeof App !== 'undefined') {
    return _extends({ en: _en2.default }, App.I18n);
  }
  return { en: _en2.default };
};
...
var Validators = {
  Absence: _absence2.default,
  Confirmation: _confirmation2.default,
  Exclusion: _exclusion2.default,
  Format: _format2.default,
  Inclusion: _inclusion2.default,
  Length: _length2.default,
  Numericality: _numericality2.default,
  Presence: _presence2.default,
  Size: _size2.default
};
...
Length = (function(superClass) {
  ...
  Length.prototype._selectErrorMessage = function(msg, val) {
    ...
    if (val === 1) {
      return __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].errors.messages[msg].one;
    }
    message = null;
    ref = ['few', 'many'];
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      if (this._checkVariant(variant, val)) {
        message = __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].errors.messages[msg][variant];
        break;
      }
    }
    if (message == null) {
      message = __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].errors.messages[msg].other;
    }
  ...
  Length.prototype._checkVariant = function(variant, val) {
    if (__WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].variants[variant] == null) {
      return;
    }
    return __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].variants[variant](val);
  };

  return Length;

})(__WEBPACK_IMPORTED_MODULE_0__base_coffee__["default"]);
...
var _identity_map2 = _interopRequireDefault(_identity_map);
...
_validators2.default.Base = _base4.default;

exports.Base = _base2.default;
exports.IdentityMap = _identity_map2.default;
...
Base = (function() {
    ...
    return new Promise((function(_this) {
      return function(resolve, reject) {
        ...
        return req.onload = function(e) {
          ...
          __WEBPACK_IMPORTED_MODULE_3__identity_map_coffee__["default"].add(obj);
          return resolve(obj);
        };
      };
    })(this));
  ...
  Base.__getResourcesUrl = function(opts) {
    ...
    resourcesUrl = this.resources == null ? "/" + (this.getRemoteName().toLowerCase()) + "s" : opts.resource ? this.resources[opts.resource].url : (__WEBPACK_IMPORTED_MODULE_1__env___default()().scope != null) && (this.resources[__WEBPACK_IMPORTED_MODULE_1__env___default()().scope] != null) ? this.resources[__WEBPACK_IMPORTED_MODULE_1__env___default()().scope].url : this.resources.url;
    if (__WEBPACK_IMPORTED_MODULE_1__env___default()().loco.protocolWithHost != null) {
      resourcesUrl = "" + (__WEBPACK_IMPORTED_MODULE_1__env___default()().loco.protocolWithHost) + resourcesUrl;
    }
  ...
  Base.__initSubclass = function(params) {
    ...
    if (parts.length === 1) {
      model = __WEBPACK_IMPORTED_MODULE_4__models___default()()[parts[0]];
      if (model == null) {
        return new this(params);
      }
      return new model(params);
    }
    model = __WEBPACK_IMPORTED_MODULE_4__models___default()()[parts[0]][parts[1]];
    return new model(params);
  };
  ...
  Base.__page = function(i, opts, reqOpts, resp) {
    ...
    if (httpMethod === 'GET') {
      url = url + '?' + __WEBPACK_IMPORTED_MODULE_2__utils___default.a.Obj.toURIParams(data);
    }
    req = new XMLHttpRequest();
  ...
  Base.__getPaginationParam = function() {
    ...
    defaultParam = 'page';
    if ((__WEBPACK_IMPORTED_MODULE_1__env___default()().scope != null) && (this.resources != null) && (this.resources[__WEBPACK_IMPORTED_MODULE_1__env___default()().scope] != null)) {
      param = (ref = this.resources[__WEBPACK_IMPORTED_MODULE_1__env___default()().scope]) != null ? (ref1 = ref.paginate) != null ? ref1.param : void 0 : void 0;
  ...
  Base.__getPaginationPer = function() {
    ...
    if ((__WEBPACK_IMPORTED_MODULE_1__env___default()().scope != null) && (this.resources != null) && (this.resources[__WEBPACK_IMPORTED_MODULE_1__env___default()().scope] != null)) {
      return (ref = this.resources[__WEBPACK_IMPORTED_MODULE_1__env___default()().scope]) != null ? (ref1 = ref.paginate) != null ? ref1.per : void 0 : void 0;
    }
  ...
  Base.prototype.isValid = function() {
    ...
    for (name in ref) {
      ...
      for (validationName in ref1) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_0__validators___default.a[validator] == null) {
          console.log("Warning! \"" + validator + "\" validator is not implemented!");
          continue;
        }
        pvs = this.__processedValidationSettings(validationSettings);
        __WEBPACK_IMPORTED_MODULE_0__validators___default.a[validator].instance(this, name, pvs).validate();
      }
    }
  ...
  Base.prototype.changes = function() {
    ...
    result = {};
    currentObj = __WEBPACK_IMPORTED_MODULE_3__identity_map_coffee__["default"].find(this.getIdentity(), this.id);
    ref = this.attributes();
    for (name in ref) {
      val = ref[name];
...
Absence = (function(superClass) {
  ...
  Absence.prototype._addErrorMessage = function() {
    var message;
    message = this.opts.message != null ? this.opts.message : __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].errors.messages.present;
    return this.obj.addErrorMessage(message, {
      "for": this.attr
    });
  };
...
/* harmony default export */ __webpack_exports__["default"] = (Absence);
...
Confirmation = (function(superClass) {
  ...
  Confirmation.prototype._addErrorMessage = function() {
    ...
    attrNames = __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].attributes[this.obj.getIdentity()];
    attrName = (attrNames && attrNames[this.attr]) || defaultAttrName;
    message = this.opts.message != null ? this.opts.message : __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].errors.messages.confirmation;
...
Exclusion = (function(superClass) {
  ...
  Exclusion.prototype._addErrorMessage = function() {
    var message;
    message = this.opts.message != null ? this.opts.message : __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].errors.messages.exclusion;
    return this.obj.addErrorMessage(message, {
      "for": this.attr
    });
  };
...
/* harmony default export */ __webpack_exports__["default"] = (Exclusion);
...
Format = (function(superClass) {
  ...
  Format.prototype._addErrorMessage = function() {
    var message;
    message = this.opts.message != null ? this.opts.message : __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].errors.messages.invalid;
    return this.obj.addErrorMessage(message, {
      "for": this.attr
    });
  };
...
Inclusion = (function(superClass) {
  ...
  Inclusion.prototype._addErrorMessage = function() {
    var message;
    message = this.opts.message != null ? this.opts.message : __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].errors.messages.inclusion;
    return this.obj.addErrorMessage(message, {
      "for": this.attr
    });
  };
...
/* harmony default export */ __webpack_exports__["default"] = (Inclusion);
...
Numericality = (function(superClass) {
  ...
  Numericality.prototype._addNaNErrorMessage = function() {
    var message;
    message = this.opts.message != null ? this.opts.message : __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].errors.messages.not_a_number;
    return this.obj.addErrorMessage(message, {
      "for": this.attr
    });
  };
  ...
  Numericality.prototype._addIntErrorMessage = function() {
    var message;
    message = __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].errors.messages.not_an_integer;
    return this.obj.addErrorMessage(message, {
      "for": this.attr
    });
  };
  ...
  Numericality.prototype._addGreatherThanErrorMessage = function() {
    var message;
    message = __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].errors.messages.greater_than;
  ...
  Numericality.prototype._addGreatherThanOrEqualToErrorMessage = function() {
    var message;
    message = __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].errors.messages.greater_than_or_equal_to;
  ...
  Numericality.prototype._addEqualToErrorMessage = function() {
    var message;
    message = __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].errors.messages.equal_to;
  ...
  Numericality.prototype._addLessThanErrorMessage = function() {
    var message;
    message = __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].errors.messages.less_than;
  ...
  Numericality.prototype._addLessThanOrEqualToErrorMessage = function() {
    var message;
    message = __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].errors.messages.less_than_or_equal_to;
  ...
  Numericality.prototype._addOtherThanErrorMessage = function() {
    var message;
    message = __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].errors.messages.other_than;
  ...
  Numericality.prototype._addOddErrorMessage = function() {
    var message;
    message = __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].errors.messages.odd;
    return this.obj.addErrorMessage(message, {
      "for": this.attr
    });
  };
  ...
  Numericality.prototype._addEvenErrorMessage = function() {
    var message;
    message = __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].errors.messages.even;
    return this.obj.addErrorMessage(message, {
      "for": this.attr
    });
  };
...
/* harmony default export */ __webpack_exports__["default"] = (Numericality);
...
Presence = (function(superClass) {
  ...
  Presence.prototype._addErrorMessage = function() {
    var message;
    message = this.opts.message != null ? this.opts.message : __WEBPACK_IMPORTED_MODULE_1__i18n___default()()[__WEBPACK_IMPORTED_MODULE_2__env___default()().loco.getLocale()].errors.messages.blank;
    return this.obj.addErrorMessage(message, {
      "for": this.attr
    });
  };
...
Size = (function(superClass) {
  ...
  Size.prototype.validate = function() {
    return __WEBPACK_IMPORTED_MODULE_1__length_coffee__["default"].instance(this.obj, this.attr, this.opts).validate();
  };
