...
App.Line = (function() {
    ...
    return App.Channels.Loco.NotificationCenter = App.cable.subscriptions.create({
      ...
      received: (function(_this) {
        return function(data) {
          ...
          return _this._processSystemNotification(data.loco);
        };
      })(this)
    });
  };
  ...
  Line.prototype._processSystemNotification = function(data) {
    ...
    if (data.uuid != null) {
      return wire.setUuid(data.uuid);
    } else if (data.notification != null) {
      return wire.processNotification(data.notification);
    } else if (data.connection_check != null) {
      return this.send({
        loco: {
          connection_check: true
        }
      });
    } else if (data.xhr_notifications != null) {
      return wire.check();
    }
  };
